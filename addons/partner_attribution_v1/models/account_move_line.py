...
class AccountMoveLine(models.Model):
    ...
    def reconcile(self):
        ...
        # FIX: Catch "in_payment" status and call the correct process_ledger function
        to_process = moves_after.filtered(lambda m: m.state == "posted" and m.payment_state in ("paid", "in_payment"))
        if to_process:
